            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="vision-mission-box same">
                        ...
                        <h3>Our vision</h3>
                        <p>Our philosophy is uncomplicated, combining creativity with the latest research and technological advances. Our approach is completely customer-centric, prioritizing them in all situations and constantly seeking to earn and deserve the trust of each one of them. In this way, we are attentive to customer demands, staying up to date with the latest trends in technology and continually improving our web hosting products and services to ensure we deliver on this vision in an increasingly effective way.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="vision-mission-box same">
                        ...
                        <h3>Our Mission</h3>
                        <p>Our mission is clear: to provide hassle-free, customer-focused, reliable and affordable web hosting services. We aim to maintain a profitable web hosting company that keeps customers happy. From the beginning, we have backed our rock-solid hosting solutions and state-of-the-art infrastructures with the best customer service and technical support available.</p>
                    </div>
                </div>
            </div>
        </div>
