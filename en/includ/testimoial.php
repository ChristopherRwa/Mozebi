        ...
        <div class="home-testimoial-main">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <span class="customers-cont">760+</span>
                        <h3>Customers trust us</h3>
                        <p>We host over 760 happy customers. Customers from small sites to high traffic sites.</p>
                        <a href="https://www.trustpilot.com/review/mozaweb.co.mz" class="commen-btn">WHAT THEY HAVE TO SAY</a>
                    </div>
                </div>
                <div class="col-lg-7">
