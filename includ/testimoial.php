...
<div class="home-testimoial-block">
    <div class="container">
        <div class="home-testimoial-main">
            <div class="row">
                <div class="col-lg-5">
                    <div class="home-testimoial-left">
                        <span class="customers-cont">+ de 760</span>
                        <h3>Clientes confiam em nós</h3>
                        <p>Hospedamos mais de 760 clientes felizes. Clientes de sites pequenos a sites de alto tráfego.</p>
                        <a href="https://www.trustpilot.com/review/mozaweb.co.mz" class="commen-btn">O QUE ELES TÊM A DIZER</a>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="home-testimoial-right">
