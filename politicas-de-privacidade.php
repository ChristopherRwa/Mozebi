...
<p>Quando um cliente solicita o nosso serviço, recolhemos as seguintes informações:</p>
<ul class="privacy">
    <li>Informações de contacto tradicionais, como o endereço para correspondência, o número de telefone e o número de fax.</li>
    <li>Informações de contacto na Internet, como endereços de e-mail.</li>
    <li>Informações do cartão de crédito.</li>
    <li>Informações sobre o sistema do computador do utilizador, como o tipo de navegador da Web, o endereço IP e o sistema operativo.</li>
    <li>Informações de identificação não financeiras, como combinações de nome de utilizador e palavra-passe.</li>
</ul>
<br>

<p><strong>Por que razão este site está a recolher informações de contacto tradicionais?</strong></p>
<p>Recolhemos informações de contacto tradicionais para os seguintes fins:</p>
<ul class="privacy">
    <li>Para efeitos de faturação e suporte.</li>
    <li>Para estabelecimento de conta de registo de domínios.</li>
    <li>Para efeitos de administração do site.</li>
    <li>Para personalizar o site para o utilizador em múltiplas visitas ao site.</li>
</ul>
<br>
...
<p>Se acredita que não estamos a tratar as suas informações de acordo com a nossa política de privacidade, por favor contacte-nos. Se por algum motivo violarmos a nossa política de privacidade, corrigiremos o erro assim que nos notificar.</p>
<br>    

<p><strong>Alterações à nossa Política de Privacidade</strong></p>
<p>Ocasionalmente, poderemos alterar a nossa Política de Privacidade. Publicaremos estas alterações nesta página para que os nossos clientes estejam sempre cientes de que informações recolhemos, como as utilizamos e em que circunstâncias as partilhamos com outras pessoas.</p>
</div>
<br><br><br><br>
</section></section></div>
<!--end plans -->
