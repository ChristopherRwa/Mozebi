            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="our-history-left">
                         <img class="img-fluid" src="img/our-history-img.png" alt="">
                    </div>
                </div>
                <div class="col-lg-8">
...
<div class="vision-mission-block">
    <div class="container">
        <div class="vision-mission-main">
            <div class="row">
                <div class="col-lg-6">
                    <div class="vision-mission-box same">
                        <img class="img-fluid" src="img/vision-icon.png" alt="">
                        <h3>Nossa visão</h3>
                        <p>Nossa filosofia é descomplicada, unindo criatividade com as mais recentes pesquisas e avanços tecnológicos. Nosso enfoque é totalmente centrado no cliente, priorizando-os em todas as situações e buscando constantemente conquistar e merecer a confiança de cada um deles. Dessa forma, estamos atentos às demandas dos clientes, mantendo-nos actualizados com as tendências mais recentes em tecnologia e aprimorando continuamente nossos produtos e serviços de hospedagem na web para garantir o cumprimento dessa visão de forma cada vez mais eficaz.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="vision-mission-box same">
                        <img class="img-fluid" src="img/mission-icon.png" alt="">
                        <h3>Nossa Missão</h3>
                        <p>Nossa missão é clara: proporcionar serviços de hospedagem na web sem complicações, focados no cliente, confiáveis e acessíveis. Almejamos manter uma empresa de hospedagem web rentável que mantenha os clientes satisfeitos. Desde o princípio, apoiamos nossas sólidas soluções de hospedagem e infra-estruturas de última geração com o melhor atendimento ao cliente e suporte técnico disponível.</p>
                    </div>
                </div>
            </div>
        </div>
